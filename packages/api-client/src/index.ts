...
export type PartSearchRequest = Schemas["PartSearchRequest"];
export type PartSearchResponse = Schemas["PartSearchResponse"];
export type SearchResult = Schemas["SearchResultResponse"];
export type FilterRequest = Schemas["FilterRequest"];
export type RangeFilterRequest = Schemas["RangeFilterRequest"];
export type OptionsFilterRequest = Schemas["OptionsFilterRequest"];
export type BoolFilterRequest = Schemas["BoolFilterRequest"];
export type TextFilterRequest = Schemas["TextFilterRequest"];
export type FacetsResponse = Schemas["FacetsResponse"];
export type EnumCount = Schemas["EnumCountResponse"];
export type BoolCounts = Schemas["BoolCountsResponse"];
export type NumberRange = Schemas["NumberRangeResponse"];
export type NumberBound = Schemas["NumberBoundResponse"];
